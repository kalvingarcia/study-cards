...
const useStyles = tss.create(({theme, role, appearance, containerRole, rippleClass}) => ({
    button: {
        ...
        color: appearance === "text" || appearance === "outlined"? theme[containerRole].onContainer.hex() : theme[role][appearance === "filled"? "onAccent" : "onContainer"].hex(),
        "&::after": {
            content: "''",
            width: "100%",
            height: "100%",
 ...
 */
export default function Button({className, role = "primary", appearance = "filled", onMouseDown, onMouseUp, children, ...props}, ref) {
